...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaverickBankk.Models.Accounts", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.AvailableLoans", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.BankEmployees", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Banks", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Beneficiaries", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Branches", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Customers", b =>
                {
                    b.Property<int>("CustomerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaverickBankk.Models.Loans", b =>
                {
                    b.Property<int>("LoanID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaverickBankk.Models.Transactions", b =>
                {
            ...
            modelBuilder.Entity("MaverickBankk.Models.Validation", b =>
                {
                    b.Property<string>("Email")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MaverickBankk.Models.Accounts", b =>
                {
                    b.HasOne("MaverickBankk.Models.Customers", "Customers")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("MaverickBankk.Models.Beneficiaries", b =>
                {
                    b.HasOne("MaverickBankk.Models.Customers", "Customer")
                        .WithMany("Beneficiaries")
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MaverickBankk.Models.Branches", "Branch")
                        .WithMany()
                        .HasForeignKey("IFSC")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MaverickBankk.Models.Branches", b =>
                {
                    b.HasOne("MaverickBankk.Models.Banks", "Banks")
                        .WithMany()
            ...
            modelBuilder.Entity("MaverickBankk.Models.Customers", b =>
                {
                    b.HasOne("MaverickBankk.Models.Validation", "Validation")
                        .WithOne("Customers")
                        .HasForeignKey("MaverickBankk.Models.Customers", "Email")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MaverickBankk.Models.Transactions", b =>
                {
                    b.HasOne("MaverickBankk.Models.Accounts", "DestinationAccount")
                        .WithMany("Transfers")
                        .HasForeignKey("DestinationAccountNumber");

                    b.HasOne("MaverickBankk.Models.Accounts", "Accounts")
